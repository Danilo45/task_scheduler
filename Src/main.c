...
//round robin = nema prioriteta, samo svako jedan mili sekund systick (on je prakticno skedzuler) generise exception

void task_delay(uint32_t tick_count);

uint8_t current_task = 1;//task1 is running, 0 is idle
...
typedef struct{
	...
	void (*task_handler)(void);//function ptr to hold task handler address
}TCB_t;
